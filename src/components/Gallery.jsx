            ...
            <div className="gallerySection" style={{
                ...
                <div className="container">
                    ...
                    <div className="row" style={{position: "relative", display: "flex", justifyContent: "center", alignItems:"center"}}>
                        <div className="col-lg-3 col-sm-4 col-md-3  col-4 mb-0  mb-lg-0 px-1 px-lg-2 ">
                            <img
                                src={gal1}
                        ...
                        <div className="col-lg-3 col-sm-4 col-md-3 col-4 mb-0 mb-lg-0 px-1 px-lg-2 deletedGrid">
                            <img
                                src={gal3}
                                className="w-100 shadow-1-strong  mb-2  mb-lg-4"
                                alt="Mountains in the Clouds"
